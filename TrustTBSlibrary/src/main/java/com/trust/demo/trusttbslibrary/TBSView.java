package com.trust.demo.trusttbslibrary;
...
public class TBSView extends FrameLayout implements TbsReaderView.ReaderCallback {
    String msg= "使用方法" +
            "1:xml 创建布局" +
            ...
            "    然后就ok了";
    private static String TAG = "lhh";
    private TbsReaderView mTbsReaderView;
    private int saveTime = -1;
    private Context context;

    public TBSView(Context context) {
        this(context, null, 0);
    }

    public TBSView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TBSView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnGetFilePathListener {
        void onGetFilePath(TBSView tbsView);
    }
